...
//    Log.d("ddddd",orginalThump)
    ...
    LaunchedEffect(Unit) {
        ...
        {
            if(mediaController.currentMediaItem.mediaId.equals(isLoading))
    ...
    LaunchedEffect(mediaController) {
        while (true) {
            if (mediaController?.isConnected == true && isPlaying) {
                progress = (mediaController!!.currentPosition * 1.0f / mediaController!!.duration).coerceIn(0f, 1f)
...
//                currentTime="%02d:%02d:%02d".format(milliSec / 1000 / 60 / 60, milliSec / 1000 / 60 % 60, milliSec / 1000 % 60)
                currentTime = if (mediaController!!.duration >= 3600000) "%02d:%02d:%02d".format(mediaController!!.currentPosition / 1000 / 60 / 60, mediaController!!.currentPosition / 1000 / 60 % 60, mediaController!!.currentPosition / 1000 % 60) else "%02d:%02d".format(mediaController!!.currentPosition / 1000 / 60 % 60, mediaController!!.currentPosition / 1000 % 60)
    ...
    MediaControllerComposable(
        onPlayingChanged = { playing ->
            isPlaying = playing
            totalTime = if (mediaController!!.duration >= 3600000) "%02d:%02d:%02d".format(mediaController!!.duration / 1000 / 60 / 60, mediaController!!.duration / 1000 / 60 % 60, mediaController!!.duration / 1000 % 60) else "%02d:%02d".format(mediaController!!.duration / 1000 / 60 % 60, mediaController!!.duration / 1000 % 60)
