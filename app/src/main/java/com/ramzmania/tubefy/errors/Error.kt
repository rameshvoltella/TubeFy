...
const val NEW_PIPE_SEARCH_MORE_ERROR = 3001
const val YOUTUBE_V3_SEARCH_ERROR = 3002
const val YOUTUBE_SCRAP_ERROR = 3003

const val DATABASE_PLAYLIST_ERROR = 4000
const val DATABASE_INSERTION_ERROR = 4000
